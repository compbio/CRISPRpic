...
**If this is your first to run Python, see the manual**, [Manual_Beginner_Mac.pdf](Manual_Beginner_Mac.pdf) or [For Window10] (https://conda.io/docs/user-guide/install/windows.html)
